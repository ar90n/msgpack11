...
TEST(MSGPACK_BINARY, pack_unpack)
{
    ...
    EXPECT_EQ(dumped[0], 0xc4u);
    EXPECT_EQ(dumped[1], 0x03u);
    EXPECT_EQ(dumped[2], 0xaau);
    EXPECT_EQ(dumped[3], 0x55u);
    EXPECT_EQ(dumped[4], 0xffu);
...
TEST(MSGPACK_BINARY, pack_unpack_16_l)
{
    ...
    EXPECT_EQ(dumped[0], 0xc5u);
    EXPECT_EQ(dumped[1], 0x01u);
    EXPECT_EQ(dumped[2], 0x00u);
    EXPECT_EQ(dumped[3], 0xaau);
...
TEST(MSGPACK_STRING, pack_unpack)
{
    ...
    EXPECT_EQ(dumped[0], 0xa3u);
    EXPECT_EQ(dumped[1], 'A');
    EXPECT_EQ(dumped[2], 'B');
    EXPECT_EQ(dumped[3], 'C');
...
TEST(MSGPACK_STRING, pack_unpack_8)
{
    ...
    EXPECT_EQ(dumped[0], 0xd9u);
    EXPECT_EQ(dumped[1], 0x20u);
    EXPECT_EQ(dumped[2], 'A');
...
TEST(MSGPACK_STRING, pack_unpack_32_l)
{
    ...
    EXPECT_EQ(dumped[0], 0xdbu);
    EXPECT_EQ(dumped[1], 0x00u);
    EXPECT_EQ(dumped[2], 0x01u);
    EXPECT_EQ(dumped[3], 0x00u);
    EXPECT_EQ(dumped[4], 0x00u);
    EXPECT_EQ(dumped[5], 'A');
